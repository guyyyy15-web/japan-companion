...
export const SEARCH_CATEGORIES: SearchCategory[] = [
  {
    ...
    items: [
      ...
      q('supermarket', '🛒', 'סופרמרקט', 'Supermarket', 'スーパー'),
      q('info', 'ℹ️', 'מרכז מידע לתיירים', 'Tourist information', '観光案内所'),
      q('taxi', '🚕', 'תחנת מוניות', 'Taxi stand', 'タクシー乗り場'),
      q('water', '🚰', 'ברזיית מים', 'Drinking water', '水飲み場'),
  ...
  },
  {
    ...
    items: [
      ...
      q('cafe', '☕', 'בית קפה', 'Café', 'カフェ'),
      q('bakery', '🥐', 'מאפייה', 'Bakery', 'パン屋'),
  ...
  },
  {
    ...
    items: [
      ...
      q('park', '🌳', 'פארק', 'Park', '公園'),
      q('museum', '🏛️', 'מוזיאון', 'Museum', '美術館 博物館'),
      q('zoo', '🐧', 'גן חיות / אקווריום', 'Zoo / aquarium', '動物園 水族館'),
      q('bike', '🚲', 'השכרת אופניים', 'Bike rental / share', 'シェアサイクル'),
